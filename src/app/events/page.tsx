      ...
      <main className="max-w-6xl mx-auto px-6 py-10 pb-20">
        <header className="mb-10">
          ...
          <p className="text-foreground-muted mt-2 max-w-2xl">
            Lives, mentorias, workshops e rituais ao vivo com o Polímata. Inscreva-se nos próximos encontros e acompanhe a Ordem em tempo real.
          </p>
        </header>
